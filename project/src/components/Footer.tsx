...
const Footer = () => {
  return (
    <footer className="bg-spark-darkest text-white py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-1">
            <Link to="/" className="flex items-center space-x-2 mb-4">
              ...
              <span className="font-bold text-xl text-white">SkillSwap</span>
            </Link>
            <p className="text-gray-400 text-sm mb-4">
              Discover, showcase, and exchange talents with others around the world.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/upload" className="text-gray-400 hover:text-white transition-colors">OneChance Upload</Link>
              </li>
              <li>
                <Link to="/skillswap" className="text-gray-400 hover:text-white transition-colors">DreamSwap</Link>
              </li>
              <li>
